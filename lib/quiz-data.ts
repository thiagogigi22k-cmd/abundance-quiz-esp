...
export const quizSteps: QuizStep[] = [
  ...
  // Step 17 (index 16) - Question
  {
    ...
    options: ["Sí, completamente", "Estoy empezando a verlo", "No estoy seguro/a"],
    balanceAdd: 0,
    progressAdd: 4,
  },
  ...
  // Step 23 (index 22) - Question
  {
    ...
    question: "¿Estás listo/a para recibir más de lo que jamás imaginaste?",
    options: ["¡SÍ! Estoy listo/a", "Quiero estar listo/a", "Necesito más fe"],
    balanceAdd: 0,
    progressAdd: 4,
  },
  ...
  // Step 26 (index 25) - Question
  {
    type: "question",
    category: "Rompiendo Bloqueos",
    question: "¿Estás dispuesto/a a liberar toda energía negativa y abrazar tu nuevo comienzo?",
  ...
  // Step 27 (index 26) - Question
  {
    ...
    options: ["¡Sí, las rompo ahora!", "Eso espero", "No estoy seguro/a"],
    balanceAdd: 0,
    progressAdd: 4,
  },
  ...
  // Step 30 (index 29) - Question
  {
    ...
    question: "¿Estás listo/a para dar el paso final hacia tu vida abundante?",
    options: ["¡Sí, estoy totalmente comprometido/a!", "Casi listo/a", "Necesito más guía"],
    balanceAdd: 0,
    progressAdd: 4,
  },
